...
impl Scale2D {
    ...
    pub fn from<T: Into<f64>>(x: T, y: T) -> Scale2D {
        Scale2D { x: x.into() as f32, y: y.into() as f32 }
    }
...
impl Scale3D {
    ...
    pub fn from<T: Into<f64>>(x: T, y: T, z: T) -> Scale3D {
        Scale3D { x: x.into() as f32, y: y.into() as f32, z: z.into() as f32 }
    }
...
mod tests {
    ...
    #[test]
    fn scale_2d_from() {
        let scale_2d_def = Scale2D::from(120, 74);
        let scale_2d_fdef = Scale2D::from(120.0, 74.0);
        let scale_2d_u8 = Scale2D::from(120u8, 74u8);
        let scale_2d_u16 = Scale2D::from(120u16, 74u16);
        let scale_2d_u32 = Scale2D::from(120u32, 74u32);
        let scale_2d_i8 = Scale2D::from(120i8, 74i8);
        let scale_2d_i16 = Scale2D::from(120i16, 74i16);
        let scale_2d_i32 = Scale2D::from(120i32, 74i32);
        let scale_2d_f32 = Scale2D::from(120.0f32, 74.0f32);
        let scale_2d_f64 = Scale2D::from(120.0f64, 74.0f64);
        let scale_2d = Scale2D { x: 120.0, y: 74.0 };
        assert_eq!(scale_2d_def, scale_2d);
        assert_eq!(scale_2d_fdef, scale_2d);
		assert_eq!(scale_2d_u8, scale_2d);
		assert_eq!(scale_2d_u16, scale_2d);
		assert_eq!(scale_2d_u32, scale_2d);
		assert_eq!(scale_2d_i8, scale_2d);
		assert_eq!(scale_2d_i16, scale_2d);
		assert_eq!(scale_2d_i32, scale_2d);
		assert_eq!(scale_2d_f32, scale_2d);
		assert_eq!(scale_2d_f64, scale_2d);
    }
    ...
    #[test]
    fn scale_3d_from() {
        let scale_3d_def = Scale3D::from(120, 74, 33);
        let scale_3d_fdef = Scale3D::from(120.0, 74.0, 33.0);
        let scale_3d_u8 = Scale3D::from(120u8, 74u8, 33u8);
        let scale_3d_u16 = Scale3D::from(120u16, 74u16, 33u16);
        let scale_3d_u32 = Scale3D::from(120u32, 74u32, 33u32);
        let scale_3d_i8 = Scale3D::from(120i8, 74i8, 33i8);
        let scale_3d_i16 = Scale3D::from(120i16, 74i16, 33i16);
        let scale_3d_i32 = Scale3D::from(120i32, 74i32, 33i32);
        let scale_3d_f32 = Scale3D::from(120.0f32, 74.0f32, 33.0f32);
        let scale_3d_f64 = Scale3D::from(120.0f64, 74.0f64, 33.0f64);
        let scale_3d = Scale3D { x: 120.0, y: 74.0, z: 33.0 };
        assert_eq!(scale_3d_def, scale_3d);
        assert_eq!(scale_3d_fdef, scale_3d);
		assert_eq!(scale_3d_u8, scale_3d);
		assert_eq!(scale_3d_u16, scale_3d);
		assert_eq!(scale_3d_u32, scale_3d);
		assert_eq!(scale_3d_i8, scale_3d);
		assert_eq!(scale_3d_i16, scale_3d);
		assert_eq!(scale_3d_i32, scale_3d);
		assert_eq!(scale_3d_f32, scale_3d);
		assert_eq!(scale_3d_f64, scale_3d);
    }
